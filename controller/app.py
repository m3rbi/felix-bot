...
from search_torrent_handler import get_start_download_handler, search_torrent_handler
...
def main():
    ...
    application.add_handler(CallbackQueryHandler(get_start_download_handler(client_url)))
